...
$status_colors = [
    ...
    'shipping' => '#007bff', 'delivered' => '#28a745', 'cancelled' => '#dc3545'
];
$status_text = [
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .order-info { background: #f8f9fa; border-radius: 10px; padding: 20px; margin-bottom: 20px; }
        .info-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin-bottom: 15px; }
        .info-item { text-align: center; padding: 10px; background: white; border-radius: 8px; }
        ...
        .status { padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; color: white; text-transform: uppercase; display: inline-block; }
        .price { color: #e74c3c; font-weight: 600; }
        .products-section h3 { margin-bottom: 15px; color: #333; }
        .product-item { display: flex; align-items: center; padding: 15px; border: 1px solid #e0e0e0; border-radius: 8px; margin-bottom: 10px; background: white; }
        .product-image { width: 60px; height: 60px; border-radius: 8px; object-fit: cover; margin-right: 15px; background: #f8f9fa; }
        .product-info { flex: 1; }
        ...
        .btn { padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: 500; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 5px; }
        ...
        @media (max-width: 768px) {
            ...
            .product-image { margin-right: 0; margin-bottom: 10px; }
